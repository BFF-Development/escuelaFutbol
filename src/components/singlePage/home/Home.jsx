...
const Home = () => {
  ...
  return (
    <div className="home" id="home" >
      ...
      <div className="containerHome">
        ...
        <div className="boxText_home">
          ...
          <p className='description_hero'>
             ...
             <br /> <span> ¡Ven y descubre cómo podemos ayudar a tu hijo / hija a alcanzar sus sueños!</span> 
          </p>
        </div>
      </div>
      ...
      <div className="anda">
        <p>ANDÁ PA ALLÁ</p>
        <svg width="893" height="46" viewBox="0 0 893 46" fill="none" xmlns="https://www.w3.org/2000/svg">
